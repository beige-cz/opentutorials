...
<html>
  ...
  <body id="target">
    <header>
      ...
      <h1><a href="http://localhost:8080/tmp_form/index.php">Javascript</a></h1>
    </header>
      ...
      <ol>
        <?php
          while($row = mysqli_fetch_assoc($result)){
            echo '<li><a href="http://localhost:8080/tmp_form/index.php?id='.$row['id'].'">'.htmlspecialchars($row['title']).'</a></li>'."\n";
        }
        ?>
      </ol>
    </nav>
    ...
    <div class="control">
      ...
      <a href="http://localhost:8080/tmp_form/write.php">쓰기</a>
    </div>
